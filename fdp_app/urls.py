...
urlpatterns = patterns('',
    ...
    url(r'^ajouter_evenement/(?P<section_slug>[-_\w\d]{1,200})/$', views.add_event_view, name='fdp_app-add_event_view'),
    url(r'^ajouter_photo$', views.add_picture_view, name='fdp_app-add_picture_view'),    
    url(r'^modifier_evenement/$', views.modify_event_view, name='fdp_app-modify_event_view'),
